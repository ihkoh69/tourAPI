...
<form id="form" action="write" method="get">
  <div class="mb-3 row">
  ...
  <div class="mb-3 row">
	...
	<div class="row mt-5">
	  ...
	  <textarea name="content" class="form-control border-success-subtle" id="inpContent" rows="8"></textarea><br>
	</div>	
	<div class="row mt-3">
		<div class="d-flex col gap-2">
			...
			<script>
				function formCheck(){
					...
					if(inpWriter.value.trim() != "" && inpTitle.value.trim() != "" && inpContent.value.trim() != ""){
