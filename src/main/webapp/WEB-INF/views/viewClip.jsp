	...
	<form action="write" method="get">
	  ...
	  <div class="mb-3 row">
		...
		<div class="row mt-2" style="display: none;">
		    <label for="inpTitle" class="col-sm-1 col-form-label">영상URL</label>
		    <div class="col-sm-11">
		      <input type="text" class="form-control border-success-subtle" id="inpClipUrl" value="${record.clip_url}">
		    </div>
   	...
   	<div class="buttons d-flex justify-content-between align-items-center mt-3 mb-5 gap-2 pr-3">
		<div class="d-flex justify-content-start align-items-center gap-2">
			<div>
				<a href="writeClipForm"><button type="button" class="btn btn-primary">글쓰기</button></a>
			</div>
			<div>
				<a href="listClip"><button type="button" class="btn btn-primary" >목록</button></a>
			</div>
		</div>
		<div class="d-flex justify-content-end align-items-center">
			...
			<script>
				function delCheck(){
					...
					if(answer) {
						document.location.href=`deleteClip?id=${record.id}`
					}
				}	
			</script>
		</div>
